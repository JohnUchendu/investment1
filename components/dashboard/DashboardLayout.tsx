...
export default function DashboardLayout({ user }: DashboardLayoutProps) {
  ...
  const renderContent = () => {
    switch(activeTab) {
      case 'dashboard': return <TradingChart />;
      case 'deposit': return <Deposit />;
      case 'withdraw': return <Withdraw />;
      // Add other cases...
      default: return <TradingChart />;
    }
  };
    ...
    <div className="flex flex-col md:flex-row h-screen bg-gray-100">
      ...
      `}>
        <div className="flex justify-between items-center mb-6 md:mb-8">
          <h2 className="text-xl font-bold hidden md:block">ForexPro</h2>
          {isMobile && (
            <button 
        ...
        <nav className="mt-8">
          <button 
            ...
            className={`w-full text-left py-3 px-4 rounded-lg mb-2 ${activeTab === 'dashboard' ? 'bg-blue-600' : 'hover:bg-blue-700'}`}
          >
            Trading Dashboard
          </button>
          ...
          <button 
            ...
            className={`w-full text-left py-3 px-4 rounded-lg mb-2 ${activeTab === 'deposits' ? 'bg-blue-600' : 'hover:bg-blue-700'}`}
          >
            Deposits 
          </button>
          <button 
            ...
            className={`w-full text-left py-3 px-4 rounded-lg mb-2 ${activeTab === 'editprofile' ? 'bg-blue-600' : 'hover:bg-blue-700'}`}
          >
            Edit Profile
          </button>
          <button 
            ...
            className={`w-full text-left py-3 px-4 rounded-lg mb-2 ${activeTab === 'deposit' ? 'bg-blue-600' : 'hover:bg-blue-700'}`}
          >
            Deposit
          </button>
          <button 
            ...
            className={`w-full text-left py-3 px-4 rounded-lg mb-2 ${activeTab === 'withdraw' ? 'bg-blue-600' : 'hover:bg-blue-700'}`}
          >
            Withdraw
          </button>
          <button 
            ...
            className={`w-full text-left py-3 px-4 rounded-lg mb-2 ${activeTab === 'verification' ? 'bg-blue-600' : 'hover:bg-blue-700'}`}
          >
            Verification
          </button>
